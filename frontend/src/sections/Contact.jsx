          ...
          <form onSubmit={handleSubmit}>
            <div className="relative mt-5">
              <input
                ...
                required
                value={formData.name}
                className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-paleHoney transition focus:outline-none focus:border-paleHoney focus:bg-gray-500/5"
                placeholder="Name"
                onChange={(e) =>
