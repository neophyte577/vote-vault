...
import { HyperText } from "../animations/HyperText";

export const About = () => {

  const [revealWhat, setRevealWhat] = useState(false);
  const [revealHow, setRevealHow] = useState(false);
    ...
    >
        <div className="max-w-5xl mx-auto px-4">
          <RevealOnScroll>
            ...
            <div className="flex justify-center mt-16 md:mt-20 mb-8 md:mb-14">
              <VoteVaultIcon className="w-[8rem] h-[8rem] md:w-[11.5rem] md:h-[11.5rem] text-paleHoney mx-auto md:translate-y-[6px]" />
            </div>
          
            {/* <h2 className="text-5xl md:text-7xl font-bold mt-4 mb-14 md:mt-8 md:mb-18 text-paleHoney text-center">
              About
            </h2> */}
          ...
          <div className="space-y-3 md:space-y-8">
            {/* WHAT */}
            <RevealOnScroll onReveal={() => setRevealWhat(true)}>
              <div className="flex flex-col md:flex-row md:items-center md:gap-12">
                <HyperText triggerOnce={revealWhat} className="text-[30px] md:text-5xl font-orbitron font-bold text-paleHoney text-center md:text-center md:w-1/3 mb-2 md:mb-0"
                  duration={1500}
                  delay={2000}    
                  animateOnHover={true}
                >
                ...
                <p className="text-lg md:text-xl text-cream md:w-2/3 border-white/10 border rounded-xl p-6">
            ...
            <RevealOnScroll onReveal={() => setRevealHow(true)}>
              {/* HOW */}
              <div className="flex flex-col md:flex-row-reverse md:items-center md:gap-12">
                <HyperText triggerOnce={revealHow} className="text-[30px] md:text-5xl font-orbitron font-bold text-paleHoney text-center md:text-center md:w-1/3 mb-2 md:mb-0"
                  duration={1500}
                  delay={2750}
                  animateOnHover={true}
                >
            ...
            <RevealOnScroll onReveal={() => setRevealWhy(true)}>

              {/* WHY */}
              <div className="flex flex-col md:flex-row md:items-center md:gap-12">
                <HyperText triggerOnce={revealWhy} className="text-[30px] md:text-5xl font-orbitron font-bold text-paleHoney text-center md:text-center md:w-1/3 mb-2 md:mb-0"
                  duration={1500}
                  delay={3250}
                  animateOnHover={true}
                >
